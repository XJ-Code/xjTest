...
//        var head =heading.substring(1,2);
//        document.execCommand('fontSize', false, head);
    } else {
        var headings=heading.substring(1,2);
        if(headings==1){
            headings=5;
        }else if(headings==2){
            headings=4;
        ...
        document.execCommand("fontSize", false, headings);
    }
...
zss_editor.insertImage = function(url, alt,xjStr) {
    var xjW = 100;
    var xjH = 100 / xjStr;
    zss_editor.restorerange();
