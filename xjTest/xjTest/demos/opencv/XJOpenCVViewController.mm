...
#import "XJOpenCVViewController.h"


@interface XJOpenCVViewController ()

@end

@implementation XJOpenCVViewController
...
- (void)viewDidLoad
{
    ...
    UIImage *mImage =  [UIImage imageNamed:@"bbb.jpg"];
    ...
    UIImage *mImage1 =  [UIImage imageNamed:@"aaa.jpg"];
